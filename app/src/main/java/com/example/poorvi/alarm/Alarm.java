...
package com.example.poorvi.alarm;
...
public class Alarm implements Comparable<Alarm>
{
  ...
  {
    intent.putExtra("com.example.poorvi.alarm.id", mId);
    intent.putExtra("com.example.poorvi.alarm.title", mTitle);
    intent.putExtra("com.example.poorvi.alarm.date", mDate);
    intent.putExtra("com.example.poorvi.alarm.alarm", mEnabled);
    intent.putExtra("com.example.poorvi.alarm.occurence", mOccurence);
    intent.putExtra("com.example.poorvi.alarm.days", mDays);
  }

  public void fromIntent(Intent intent)
  {
    mId = intent.getLongExtra("com.example.poorvi.alarm.id", 0);
    mTitle = intent.getStringExtra("com.example.poorvi.alarm.title");
    mDate = intent.getLongExtra("com.example.poorvi.alarm.date", 0);
    mEnabled = intent.getBooleanExtra("com.example.poorvi.alarm.alarm", true);
    mOccurence = intent.getIntExtra("com.example.poorvi.alarm.occurence", 0);
    mDays = intent.getIntExtra("com.example.poorvi.alarm.days", 0);
    update();
  }
